    ...
    <div className="flex flex-col items-center">
      <div className="relative" style={{ width: s.outer, height: s.outer + 14 }}>
        ...
        >
          ...
          >
            <span style={{ fontSize: s.emoji, filter: locked ? "grayscale(1) opacity(0.5)" : "none" }}>
              {locked ? "🔒" : icon}
            </span>
          </div>
        </div>
      ...
      <p className={`mt-3 text-center font-display ${s.textLabel} leading-tight ${locked ? "text-muted-foreground" : "text-ink"}`}>{label}</p>
